    ...
    <section class="section-content">
        <div class="container-fluid">
            <div class="dashboard-heading pt-3">
                <h2 class="dashboard-title fs-4 fw-bold">Artilce Category</h2>
                <p class="dashboard-subtitle">Add New Article Category</p>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="row d-flex justify-content-center">
                            <form action="{{ route('life-at-ideatax.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
