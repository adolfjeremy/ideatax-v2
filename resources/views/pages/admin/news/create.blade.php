    ...
    <section class="section-content">
        <div class="container-fluid">
            <div class="dashboard-heading">
                ...
                <p class="dashboard-subtitle">Add New News</p>
            </div>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center">
                                    <form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-12 mb-3">
                                            <label for="photo" class="form-label">News Thumbnail</label>
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-warning d-block w-100">Post News</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
