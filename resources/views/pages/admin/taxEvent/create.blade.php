    ...
    <section class="section-content">
        <div class="container-fluid">
            <div class="dashboard-heading pt-3">
                <h2 class="dashboard-title fs-4 fw-bold">Tax Event</h2>
                <p class="dashboard-subtitle">Create New Tax Event</p>
            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row d-flex justify-content-center">
                            <form action="{{ route('event.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-12 mb-3">
                                    <label for="title_jpn" class="form-label">Tax Event Title Jpn</label>
                                ...
                                <div class="col-12 mb-3">
                                    <label for="body_jpn">Tax Event Body Jpb</label>
