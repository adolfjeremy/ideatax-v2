<ul class="d-block p-1 border-top">
    ...
    <li class="nav-item dropdown dropdown-mobile-custom py-2">
        <a class="nav-link dropdown-toggle {{ (request()->is('id/careers*') ? " active" : "") }}" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        Career
        </a>
        ...
        <li><a class="dropdown-item py-2" href="#">Life at IdeataxAction</a></li>
        </ul>
    </li>
    <li class="nav-item py-2">
