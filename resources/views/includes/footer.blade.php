<footer>
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-7 mt-4 mt-md-0 text-start">
                <h2>Address</h2>
                <ul>
                    <li class="mt-2 pe-5">
                        <div class="icon">
        ...
        <div class="row p-2">
            <div class="col-12 text-center">
                <hr>
                <h3>&copy; Idea<strong>tax</strong> 2022</h3>
                <p>Developed by <a href="https://github.com/adolfjeremy" target=”_blank” rel="noopener" rel=”noreferrer”>Jeremy</a></p>
            </div>
        </div>
    </div>
</footer>